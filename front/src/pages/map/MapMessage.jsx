...
export const MapMessage = ({socket, lat, lng, address, time, chatid, boardid, customer, seller}) => {
  ...
  return (
    <>
      ...
      <ReserveInfo seller={seller} socket={socket} address={address} time={time} chatid={chatid} boardid={boardid} customer={customer} />
    </>
  );
};
