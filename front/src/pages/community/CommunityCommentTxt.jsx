import { CommentWrapper, Txt, Img, CommentInput, ContentInput, CommentButton, ReplyButton, ModifyInput, MDButtons, ButtonMD } from "./styled"
...
//각각의 댓글 하나를 가르킴
export const CommentTxt = ({ idx, content, createdAt, comments, setComments, email, username, img, parentId, isDeleted, currentPage,
  setTotalComments, totalComments, setPageNumbers, setSelectPage
}) => {
      ...
      <CommentWrapper parentId={parentId} isDeleted={isDeleted} deleteRender={deleteRender}>
          {createdAt && !isInput ? (
              ...
              <Txt idx={idx}>
                  ...
                  {!reply ? <ReplyButton type="button" onClick={()=>{
                      setReply(!reply)}}>답글</ReplyButton> : 
                      <>  
