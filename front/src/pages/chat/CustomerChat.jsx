...
import { chat, userSetReservation } from "../../store"
...
export const CustomerChat = ({ boardid }) => {
  ...
  //     const { data } = await request.get(`/chats?customer=${user.email}&opponent=${sellerData.email}&boardid=${boardid}`);
  ...
  //       </ChatForm>
  //       <Modal isOpen={isOpen} setIsOpen={setIsOpen} height="37rem">
  //         <ChatterMap setIsOpen={setIsOpen} setIsReserved={setIsReserved} boardid={boardid} customer={user.email} />
  //       </Modal>
  //     </CustomerChatWrap>
  // );
